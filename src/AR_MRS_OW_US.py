...
class AR_SC_Markov_OW_US():
    ...
    def initialize_model(self):
        print("Model Initialization : \n"
              "Model : Markov Auto Regression with Optimal Weights and Uknown States \n"
    ...
    def optimal_weigths(self):
        ...
        self.df['Modified_GR_GNP'] = self.df["GR_GNP"]*w
        self.df['Modified_GR_GNP'] = self.df['Modified_GR_GNP'].fillna(0)
